                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" readonly name="slug" value="{{ $products->slug }}" id="slug" class="form-control" placeholder="Slug">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12" >
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sku" value="{{ $products->sku }}" id="sku" class="form-control" placeholder="sku">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="barcode" value="{{ $products->barcode }}" id="barcode" class="form-control" placeholder="Barcode">
                                        </div>
                                    </div>
                                    <div class="col-md-12">

                                        <!-- Mind blowing piece of work done here -->

                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox">
                                                <input type="hidden" name="track_qty" value="No">
                                                <input class="custom-control-input" type="checkbox" id="track_qty" value="Yes"
                                                       {{($products->track_qty == 'Yes') ? 'checked' : ''}} name="track_qty" checked>
                                                <label for="track_qty" class="custom-control-label">Track Quantity</label>
                                                <p class="error"></p>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <input type="number" min="0" name="qty" value="{{ $products->qty }}" id="qty" class="form-control" placeholder="Qty">
                                            <p class="error"></p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response['status'] == true) {
                        ...
                        $("input[type='text'], select, input[type='number']").removeClass('is-invalid').html('');

                        /**** Redirect after creating a product ****/
        ...
        const dropzone = $("#image").dropzone({
            ...
            headers: {
                ...
                var html_img_thumb = `<div class="col-md-3" id="image-row-${response.image_id}">
                    <div class="card">
                ...
                $("#product-gallery").append(html_img_thumb);
