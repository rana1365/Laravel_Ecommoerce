                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0);" onclick="deleteShipping(`{{ $shippingCharge->id }}`);" >
                                            <svg wire:loading.remove.delay="" wire:target="" class="text-danger filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        if(confirm("Are you sure you want to delete?")) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    /**** Redirect after creating a Shipping ****/
